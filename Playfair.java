...
public class Playfair {
   ...
   public void generateMatrices(String key) {
      ...
      String cadenaLarga = key.toLowerCase() + letters;
      Set<Character> tempSet = new LinkedHashSet<Character>();
      for (char c: cadenaLarga.toCharArray()) {
         tempSet.add(c);
      }
   ...
   public static void main(String[] args) {
      Playfair prueba = new Playfair();
      prueba.generateMatrices("FRIENDS4V@TJ_201.C");
      System.out.println("");
      prueba.printMatrices();
      System.out.println("");
      //introducir el texto a encriptar
      prueba.encrypt("brazzuca");
      System.out.println("");
      
      //introducir el texto resultado
      prueba.decrypt("b.@ xzz cpg ");
   }
